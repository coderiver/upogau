$(document).ready(function() {
	...
	$('.js-nav-slide').click(function() {
		var index = $(this).data('index');
		$(this).parents('.js-sidebar-parent').find('.js-sidebar-slider').cycle('goto', index);
		$(this).parents('.js-nav-slider').cycle('goto', index);
	});
